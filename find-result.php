...
<html lang="en">
    <head>
        ...
        <title>Collage Result Declaration</title>
        ...
        <link rel="stylesheet" href="css1/icheck/skins/flat/blue.css" >
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Collage Result Declaration</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter your Enroll Id</label>
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright@ SVIP STUDENTS </small></p>
                    </div>
