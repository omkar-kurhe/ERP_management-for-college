...
<a href="edit-class.php?classid=<?php echo htmlentities($result->id);?>" class="btn btn-info btn-xs"> Edit </a> 
  ...
  <a href="manage-classes.php?id=<?php echo $result->id;?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-xs">Delete</a>
